...
export default defineConfig(({ mode }) => {
  ...
  return {
    server: {
      port: Number(envVars.VITE_APP_PORT || 5000),
      host: "0.0.0.0",
      allowedHosts: true,
      open: false,
    },
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Tutorbuddy",
          name: "Tutorbuddy",
          description:
            "Tutorbuddy is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
